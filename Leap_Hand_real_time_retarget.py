...
import os
import sys
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "dex_retargeting"))
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "dex_retargeting", "example", "vector_retargeting"))
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "LEAP_Hand_API", "python"))
print(sys.path)
import cv2
import numpy as np
import sapien
...
from LEAP_Hand_API.python.main import LeapNode
...
def main(
    ...
    robot_dir = (
        Path(__file__).absolute().parent / "assets" / "robots" / "hands"
    )
